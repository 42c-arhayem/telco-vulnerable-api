...
const { restAuthenticate: authenticate } = require("../../shared/middleware/auth");
const Order = require("../../shared/models/Order"); // Import the Order model
const ProductOrder = require("../../shared/models/new-productOrder"); // Import the ProductOrder model
